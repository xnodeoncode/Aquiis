...
using Aquiis.Professional.Application.Services;
using Aquiis.Professional.Application.Services.PdfGenerators;
using Aquiis.Professional.Shared.Services;
using Aquiis.Professional.Shared.Authorization;
using ElectronNET.API;
using Microsoft.Extensions.Options;
using Aquiis.Professional.Application.Services.Workflows;
...
builder.Services.AddScoped<Aquiis.Professional.Application.Services.DocumentService>(); // New refactored service
...
// Workflow services
builder.Services.AddScoped<Aquiis.Professional.Application.Services.Workflows.ApplicationWorkflowService>();
