...
namespace Aquiis.Professional.Infrastructure.Data
{
    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        public DbSet<Aquiis.Professional.Application.Services.Workflows.WorkflowAuditLog> WorkflowAuditLogs { get; set; }
         ...
         protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Aquiis.Professional.Application.Services.Workflows.WorkflowAuditLog>(entity =>
            {
                entity.HasIndex(e => e.OrganizationId);
