...
namespace Aquiis.Application.Tests
{
    ...
    public class PropertyServiceTests : IDisposable
    {
        ...
        public PropertyServiceTests()
        {
            ...
            var mockCalendarSettings = new Mock<CalendarSettingsService>(_context, _mockUserContext.Object);
            var calendarService = new CalendarEventService(_context, mockCalendarSettings.Object, _mockUserContext.Object);
            
            _service = new PropertyService(_context, mockLogger.Object, _mockUserContext.Object, mockSettings, calendarService);
        }
